...
# -*- coding: utf-8 -*-
"""
Created on Mon May 11 00:15:56 2026
...
def Zone(Q,theta,phi,psi_input):
    e = 1.602e-19       # C
    hbar = 1.054e-34    # J*s
    mass = 9.11e-31     # kg
    c = 3e8             # m/s
    ...
    epsilon_dim = 1.0 #dont change
    s_dim = epsilon_dim/(2*Q)
    t_f_dim = Q*theta
    ...
    psip0 = psi_input.astype(np.complex128)
...
if __name__ == "__main__":
    ...
    psif = Zone(Q,theta[0],phi[0],psi_input)
    c0 = psif[25600-150-160:25600+150-160]
    c1 = psif[25600-150+160:25600+150+160]
    P0 = np.sum(abs(c0)**2) * dp
    P1 = np.sum(abs(c1)**2) * dp
    relative_phase = np.angle(np.vdot(c1,c0))
    print('population',[P0,P1])
    print('angle',relative_phase)
